const config = {
		...
		AHMEDABAD_BSQUARE_1_OFFICE_ADDRESS: 'Ahmedabad BSquare-1 Address Copied Successfully',
		AHMEDABAD_BSQUARE_2_OFFICE_ADDRESS: 'Ahmedabad BSquare-2 Address Copied Successfully',
	...
	COLOR_PALETTE: {
		BG_PRIMARY_COLOR: 'var(--color-theme-primary)'
	},
	PAGE_NAME: {
		BLOG: 'blog',
	...
	HEADERS: {
		CACHE_CONTROL: { KEY: 'Cache-Contol', VALUE: 'public, s-maxage=59, stale-while-revalidate=59' }
	},
	STAR_RATINGS: {
		GLASSDOOR: 4.9,
		TRUSTPILOT: 4.2,
