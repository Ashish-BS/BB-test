...
import { NoResponsePropType } from "@/types/components/component-types/NoResponse";

const NoResponseFromCms: React.FC<NoResponsePropType> = (props) => {
  return (
    <section
      className={`b-banner-section b-error-page-no-data ${
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-6">
            <div className="b-error-content b-500-error">
              {props.title ? (
                <h1>{props.title}</h1>
              ) : (
              ...
              <p>
                {props.description
                  ? props.description
                  : `We live in a world of uncertainty where anything could go
                                wrong. It's always a wise choice to revisit home.`}
              </p>
              <Link href="/">
...
export default NoResponseFromCms;
